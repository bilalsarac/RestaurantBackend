...
import com.restaurant.app.security.JwtAuthenticationEntryPoint;
import com.restaurant.app.security.JwtAuthenticationFilter;
import com.restaurant.app.services.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
               ...
               //DEBUG
                ...
                .permitAll()
                .antMatchers(HttpMethod.PUT, "/ratings/**")
                .permitAll()
